...
def get_document(url: str, max_depth: int):
...
def get_docs():
    docs = get_document("https://python.langchain.com/docs/expression_language/", 20)
    docs_pydantic = get_document(
        "https://python.langchain.com/docs/modules/model_io/output_parsers/quick_start",
        1,
    )
    docs_sq = get_document(
...
def text_split():
    ...
    concatenated_content = get_concatenated_content()
